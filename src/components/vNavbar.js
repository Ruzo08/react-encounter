            ...
            <div>
                <div class="row justify-content-end bg-dark">
                    <div class="col-3 py-2">
                        <span className="jumlah text-light me-5">0</span>
                                ...
                                <ul class="navbar-nav">
                                    <li class="nav-item dropdown ms-5">
                                        ...
                                        <ul class="dropdown-menu" aria-labelledby="navbarDropdownMenuLink">
                                            <li><a class="dropdown-item" href="#">Kursus Web Desain</a></li>
                                            <li><a class="dropdown-item" href="#">Kursus Website</a></li>
                                            <li><a class="dropdown-item" href="#">Kursus Pemrograman PHP</a></li>
                                            <li><a class="dropdown-item" href="#">Kursus JavaScript</a></li>
                                            <li><a class="dropdown-item" href="#">Kursus Node JS</a></li>
                                            <li><a class="dropdown-item" href="#">Kursus React JS</a></li>
                                            <li><a class="dropdown-item" href="#">Kursus React Native</a></li>
                                            <li><a class="dropdown-item" href="#">Kursus Android</a></li>
                                        </ul>
                                    </li>
                                    <li class="nav-item">
